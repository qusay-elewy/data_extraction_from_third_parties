...
def scrape_page(url, page_number):
    """
    Scrapes the speified page of the passed URL (i.e., paginated scrapping)
    ...
    Args:
        ...
        page_number: The number of the page to be scrapped from the specified URL
    Returns:
...
def scrape_pages(url, start_page, end_page):
    ...
    Args:
        ...
        end_page: The page index at which the application will stop data extraction
    Returns:
...
def main():
    ...
    # Process pages 3-7 of the aforementioned URL
    process_pages(url, 3, 7)
